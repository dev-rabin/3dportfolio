...
import { SiAxios, SiCloudflare, SiCss3, SiDart, SiDocker, SiExpress, SiFigma, SiFirebase, SiFlutter, SiGithub, SiGoogle, SiHtml5, SiJavascript, SiJest, SiJsonwebtokens, SiLinux, SiMongodb, SiMysql, SiNodedotjs, SiPaypal, SiPostman, SiPrisma, SiRedux, SiSocketdotio, SiStripe, SiTailwindcss, SiTypescript, SiVite } from "react-icons/si";
...
export const SKILLS = {
    ...
    Mobile: [
        ...
        { name: "Offline-First Apps", icon: FaDatabase, color: "#22C55E" },
    ...
    Tools: [
        ...
        { name: "Testing (Jest – Basics)", icon: SiJest, color: "#C21325" },
    ],

    Engineering: [
        { name: "MVC Architecture", icon: FaDatabase, color: "#A3A3A3" },
